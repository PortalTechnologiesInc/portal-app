import { CashuWalletInterface } from "portal-app-lib";

export class CashuWalletMethodsProvider {
  constructor(
    private readonly addWalletCallback: (mintUrl: string, unit: string) => Promise<CashuWalletInterface>,
    private readonly getWalletCallback: (mintUrl: string, unit: string) => CashuWalletInterface | null,
